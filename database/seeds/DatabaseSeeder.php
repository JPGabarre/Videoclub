...
class DatabaseSeeder extends Seeder
{
	...
	private $arrayCategories = array(
		array(
			'title' => 'Infantil',
			'description' => 'Peliculas para los mas peques de casa.',
			'adult' => false
		),
		array(
			'title' => 'Drama',
			'description' => 'Peliculas para no parar de llorar.',
			'adult' => false
		),
		array(
			'title' => 'Comèdia',
			'description' => 'Peliculas para no parar de reirse.',
			'adult' => true
		),
		array(
			'title' => 'Thriller',
			'description' => 'Las más emocionantes.',
			'adult' => false
		),
	);

	private $arrayFavorites = array(
		array(
			'user_id' => 1,
			'movie_id' =>1
		),
    ...
    private $arrayPeliculas = array(
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/watch?v=cpt4cXjdJz0',
			'rented' => false, 
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/watch?v=auCgsj0MV-M',
			'rented' => true, 
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/watch?v=UZ4CuWPnfeM',
			'rented' => false, 
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/watch?v=mDipxg3H37o',
			'rented' => false, 
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/watch?v=-pNMIhnlEho',
			'rented' => false, 
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/watch?v=oi7bhRmJzec',
			'rented' => false, 
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/watch?v=Ertbb3GyS8Y',
			'rented' => false, 
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/watch?v=He7IbXJy-Uk',
			'rented' => false, 
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/watch?v=yDA1mK6v-ME',
			'rented' => true, 
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/watch?v=xhzBmjdehPA',
			'rented' => true, 
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/watch?v=mDKn4VL8o10',
			'rented' => false, 
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/watch?v=MmUhbSZMjOY',
			'rented' => false, 
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/watch?v=7115nOKRFD8',
			'rented' => true, 
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/watch?v=LBbDxYuvdm4',
			'rented' => true, 
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/watch?v=XQljOh9p6P8',
			'rented' => false, 
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/watch?v=c06JMZ6uQ-U',
			'rented' => true, 
	...
	private function seedFavorites(){
		DB::table('favorites')->delete();
        foreach( $this->arrayFavorites as $favorite ) {
            $f = new Favorite;
            $f->user_id = $favorite['user_id'];
            $f->movie_id = $favorite['movie_id'];
			$f->save();
		}
	}
    ...
    public function run()
    {
		...
		self::seedFavorites();
		$this->command->info('Tabla favoritas inicializada con datos!');
